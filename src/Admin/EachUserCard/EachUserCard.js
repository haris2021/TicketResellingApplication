    ...
    return(
        <div className="row">
            ...
            <div className="card wd-eacheventcard" style={{ width: '18rem' }}>
                ...
                <img src={post.Image} className="card-img-top wd-eacheventimg" alt="ImageofEachEvent"/>
                ...
                <div className="card-body">
                    ...
                    <button className="btn btn-danger" onClick={()=>{DeleteUserbtn(post._id)}}>Delete User</button>
                </div>
