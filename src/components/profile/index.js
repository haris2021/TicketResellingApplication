                                     ...
                                     <div className="card-body">
                                         ...
                                         <div className="row">
                                             <div className="col-sm-12">
                                                 <a className="btn btn-info " target="__blank" onClick={CallEditProfile}>Edit</a>
                                             </div>
                                         </div>
                                         <div className="row">
                                             <div className="mt-5 text-center"><button className="btn btn-danger profile-button" type="button"onClick={()=>{CallDeleteBtn(u._id)}} >Delete Profile</button></div>
                                         </div>
                                     </div>
                                 </div>
