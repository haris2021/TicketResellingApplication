...
const FollowingUserInfo = () => {
    ...
    const check = async () =>
    {
        ...
        console.log("last sentace", response);
        ...
        console.log("New profile" + response._id);
        console.log("Logged In profile" + u._id);

        const followingresponse = await FindAllFollowers(u._id);
        console.log(followingresponse);
        const followingornot = followingresponse.some(user => user.followingUsername === response.Username);
        console.log("Yes or no" + ":" + followingornot);
     ...
     <div>
         ...
         <div>
             ...
             <div className="row">
                 ...
                 <div className = " col-md-5 col-lg-4 border rounded">
                     <div className="d-flex flex-column align-items-center text-center mt-2">
                         <img src={userinfo.image} alt="Admin" className="rounded-circle" width="150"/>

                         <div className="mt-3">
                             <h4>{userinfo.username}</h4>
                             <p className="text-secondary mb-1"></p>

                             {follow ? <button disabled className="btn btn-primary me-2 mb-3">Following</button> :  <button onClick={followuser} className="btn btn-primary me-2 mb-3">Follow</button> }
                             <button className="btn btn-outline-primary mb-3">Message</button>
